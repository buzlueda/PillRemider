...
# Set variables
project_path="src/PillReminder.Infrastructure/PillReminder.Infrastructure.Persistence"
startup_project_path="src/PillReminder.Presentation/PillReminder.Presentation.WebAPI"
